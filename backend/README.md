...
## Project Structure
    ...
    ├── nameless_butterfly_41875  # Django project configurations
...
1. Clone this repo and `cd nameless_butterfly_41875`
...
2. Clone this repo and `cd nameless_butterfly_41875`
